...
return [
    ...
    'auth/missing-or-invalid-nonce' => 'The OIDC ID token requires a valid unhashed nonce.',
    ...
    'auth/web-storage-uns =>pported' => 'This browser is not supported or 3rd party cookies and data may be disabled.',

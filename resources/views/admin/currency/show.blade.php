                                            ...
                                            <div class="d-flex justify-content-between pt-1">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div class="text-sm font-weight-bold">
                                                        ...
                                                        {{ $currency->created_at ? $currency->created_at->diffForHumans() : null }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex justify-content-between pt-1">
                                                <div class="d-flex justify-content-between pt-1">
                                                    <div class="text-sm font-weight-bold">
                                                        ...
                                                        {{ $currency->updated_at ? $currency->updated_at->diffForHumans() : null }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="float-right">
                            <a class="btn btn-outline-primary"
                                href="{{ route('admin.currency.edit', $currency) }}">{{ __('Edit') }}</a>
                        </div>
                    </div>
                </div>
            </div>

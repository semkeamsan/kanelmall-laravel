...
@endsection
@section('content')
    <div class="aui-content-box aui-content-box-no-header">
        <section class="p-1">
...
@push('scripts')
      ...
      <script>
        ...
        (function(d, s, id) {
          ...
          js.src = 'https://connect.facebook.net/{{ LaravelLocalization::getCurrentLocaleRegional() }}/sdk/xfbml.customerchat.js';

    ...
    <div class="container">
        <div class="tab-content translations-content-item en visible">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Kanel Mall, accessible from <a
                            href="http://8624-36-37-149-203.ngrok.io" rel="external nofollow noopener"
                            target="_blank">http://8624-36-37-149-203.ngrok.io</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: iamtestingemail2022@gmail.com</p>
                </li>
                <li>
                    <p>By phone number: 0969140554</p>
                </li>
            </ul>
        </div>
    </div>
